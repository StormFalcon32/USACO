public class Combinatorics {
	...
	public void combWithRep(int[] chosen, int[] arr, int currLength, int length, int start, int end) {
	...
	public void makeAll(int[] chosen, int[] arr, int currLength, int length) {
	...
	public void combWithoutRep(int[] chosen, int[] arr, int currLength, int length, int start, int end) {
